...
tf.app.flags.DEFINE_float("freq_of_words", 0.5, "Frequency of Words.")
tf.app.flags.DEFINE_float("learning_rate_freq_of_words", 0.99,
                          "Frequency of Words")
tf.app.flags.DEFINE_float("max_gradient_norm", 5.0,
                          "Clip gradients to this norm.")
tf.app.flags.DEFINE_integer("no_of_times", 32,
                            "Number of times to replace")
tf.app.flags.DEFINE_integer("size", 512, "Size of each model layer.")
tf.app.flags.DEFINE_integer("num_layers", 2, "Number of layers in the model.")
tf.app.flags.DEFINE_integer("s_memo_size", 30000, "Source language Memory size.")
tf.app.flags.DEFINE_integer("t_memo_size", 30000, "Memory taken to process.")
